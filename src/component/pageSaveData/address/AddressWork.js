    ...
    return (
        <div>
            ...
            >
                ...
                >
                    <Form.Item style={{ display: 'inline-block', lineHeight: '32px', width: 'calc(250px)', marginRight: '12px' }}
                        name='nameWork'
                        id='nameWork'
                    >
                    ...
                    <span style={{ display: 'inline-block', lineHeight: '32px', textAlign: 'center' }}>
                ...
                >
                    <Form.Item style={{ display: 'inline-block', lineHeight: '32px', width: 'calc(250px)', textAlign: 'center', marginRight: '80px' }}
                        name='department'
                        id='department'
                    >
                ...
                >
                    <Form.Item
                        style={{ display: 'inline-block', lineHeight: '32px', width: 'calc(250px)', marginRight: '22px' }}
                        name='group'
                        id='group'
                    >
                        {/* input Form หมู้บ้าน / อาคาร */}
                        <Input />
                    </Form.Item>
                    <span
                        style={{ display: 'inline-block', lineHeight: '32px', textAlign: 'center' }}
